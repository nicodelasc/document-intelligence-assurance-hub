...
- Decision information order: A terminal Workbench result renders one `Exception triage decision` panel in this order: verified outcome, decision brief, evidence differences and `Prepared next step` controls. Evidence ledger and activity timeline follow as separate panels.
