...
The repository includes [the current recorded walkthrough](../artifacts/walkthrough.webm) at 1440×900. It was regenerated from the two-family interface with `AI_LIVE_ENABLED=false`. On-screen chapter captions make the artifact usable without narration and state the non-execution boundaries. Provider acceptance is not established by this artifact.

## 0:00–0:18 — Two document families and the keyless boundary
...
## 0:18–0:42 — One correct fixture and three visible stages
...
## 0:42–1:10 — Discrepancy and prepared simulated workflow action
...
## 1:22–1:43 — Operations workspace
