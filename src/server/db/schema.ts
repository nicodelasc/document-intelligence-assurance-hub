export const neonSchemaStatements = [
  ...
  `ALTER TABLE daily_usage ADD COLUMN IF NOT EXISTS global_custom_uploads integer NOT NULL DEFAULT 0`,
  `ALTER TABLE daily_usage ADD COLUMN IF NOT EXISTS global_recorded_runs integer NOT NULL DEFAULT 0`,
